...
const whatMakesUsDifferent = [
  {
    title: "Businesses that live by the phone.",
    desc: "Home services, behavioral health, legal, dental — we know your buyer, your hours, and where your money leaks.",
  },
  {
  ...
  },
  {
    ...
    desc: "Booked jobs, signed cases, new patients, recovered calls — not vanity metrics.",
  },
];
      ...
      <SEOHead
        ...
        structuredData={{
          ...
          mainEntity: {
            ...
            description: "Digital agency building client-acquisition websites, CRM lead systems, and growth marketing for local service businesses.",
            foundingDate: "2023",
            areaServed: "United States",
            knowsAbout: ["Client-Acquisition Websites", "Missed-Call Text-Back Systems", "CRM & Lead Tracking", "Local SEO & Google Business Profile", "Behavioral Health Marketing"],
          },
        }}
      />
      {/* Header */}
      <section className="pt-32 pb-20 border-b border-white/5">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <AnimatedSection>
            ...
            >
              We Started in Behavioral Health. We're Growing.
            </h1>
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            <AnimatedSection>
              ...
              >
                Kind Supply Digital built its name helping behavioral health providers and treatment
                centers grow. Now we're bringing that same playbook — strategic websites, SEO, and
                growth systems — to HVAC, home services, law firms, and dental practices, plus a new
                layer: the Lead Rescue System, so the calls you earn never go unanswered.
