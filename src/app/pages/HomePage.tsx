      ...
      <section className="py-32 border-b border-white/5 bg-[#0c1525]">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <AnimatedSection delay={0.2}>
            ...
            >
              Each leak feels small. Together, at the value of one HVAC replacement,
              one signed case, or one admitted client &mdash; often $5,000 to $50,000 &mdash;
              &ldquo;fine&rdquo; becomes the most expensive thing you own.
            </p>
          </AnimatedSection>
        </div>
      </section>
