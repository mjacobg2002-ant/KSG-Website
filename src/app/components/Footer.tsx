      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            >
              Growth systems for local service businesses — client-acquisition
              websites, missed-call text-back, speed-to-lead automation, and the
              CRM that tracks every lead to the dollar.
            </p>
        ...
        <div className="mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-white/20" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.8rem" }}>
            Northern Virginia &middot; Plumbing &middot; HVAC &middot; Roofing &middot; Legal &middot; Dental &middot; Home Services
          </p>
        </div>
      </div>
    </footer>
